  ...
  <table class="table table-responsive table-bordered table-striped">
    ...
    @foreach($ResulPersonas as $persona)
        ...
        <tr>
          ...
          <td class="inner-table">{{$persona['nombre']}}</td>
          <td class="inner-table">{{$persona['apellido']}}</td>
          <td class="inner-table">{{$persona['sexo']}}</td>
          <td class="inner-table">{{$persona['ind_civil']}}</td>
          <td class="inner-table">{{$persona['edad']}}</td>
          <td class="inner-table">{{$persona['usr_registro']}}</td>
          <td class="inner-table">{{$persona['date_registro']}}</td>
        <td>
